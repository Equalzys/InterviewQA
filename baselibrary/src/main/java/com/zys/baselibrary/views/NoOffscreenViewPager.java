...
public class NoOffscreenViewPager extends ViewGroup {
    ...
    public NoOffscreenViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public NoOffscreenViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
