...
public class RxQRCode {
     ...
     * @param QR_HEIGHT 二维码的高度
     */
    public static Bitmap createQRCode(String content, int QR_WIDTH,int QR_HEIGHT)
            throws WriterException {
        Hashtable<EncodeHintType, String> hints = new Hashtable<EncodeHintType, String>();
        hints.put(EncodeHintType.CHARACTER_SET, "utf-8");
        BitMatrix matrix = new MultiFormatWriter().encode(content,BarcodeFormat.QR_CODE, QR_WIDTH, QR_HEIGHT);
